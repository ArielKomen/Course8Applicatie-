...
def bestanden_inlezen():
    ...
    """
    d2_lijst = []
    lijst_met_bestandspaden = ["/home/stephan/PycharmProjects/Course8Applicatie-/data/ziekte lijst",
                               "/home/stephan/PycharmProjects/Course8Applicatie-/data/compound lijst",
                               "/home/stephan/PycharmProjects/Course8Applicatie-/data/bitter gourd lijst"]
...
def schrijf_data_weg(export_lijst):
    ...
    bestand = open("/home/stephan/PycharmProjects/Course8Applicatie-/data/export bitter gourd en ziektes",
                   "a")

    for lijst in export_lijst:
        regel = lijst[0] + ";" + lijst[1] + ";" + lijst[2] + ";" + lijst[3] + ";" + lijst[4] + lijst[5] + "\n"
        bestand.write(regel)
